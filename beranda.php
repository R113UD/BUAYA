		...
		<div class="row">
            <div class="border padding20 span10" style="background-color: #F5F5F5;">
				<div class="panel no-border">
					<?php
						$comot=	mysqli_query($koneksi,"SELECT * FROM setup_dasboard ORDER BY id_dasboard DESC LIMIT 3");   
			...
			<div class="padding20 span4" style="background-color: #F1F1F1;">
				...
				<div class="panel no-border">
                    ...
                    <div class="panel-content fg-dark nlp nrp">
						...
						<?php
						$comot_komen = mysqli_query($koneksi,"SELECT * FROM komentar ORDER BY id_komentar DESC LIMIT 5");   
